...
|--------------------|
| O sistema fornece feedback ao usuário durante etapas essenciais, como captura de imagens, criação de pastas e início do reconhecimento facial. O progresso da captura também é comunicado, garantindo que o usuário compreenda que a tarefa está em andamento.Problema identificado: em processos longos (ex.: número alto de capturas), podem ocorrer incertezas caso o feedback não seja contínuo.
